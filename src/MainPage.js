...
import {CustomModalDemo, CustomCardDemo, SignInDemo, StickyFooterDemo, ColorPalette, FontSizeDemo} from './examples';
import './index.css';
      ...
      <div className={classes.root}>
        ...
        <main className={classes.content}>
          ...
          <Switch>
            ...
            <Route path='/fontsize' exact component={FontSizeDemo} {...props}/>
            <Route path='/designops' exact component={ColorPalette} {...props}/>
